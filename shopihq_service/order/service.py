    ...
    def order_search(self, request, user_id, **kwargs):
        ...
        for res in parsed_json:
            ...
            response_data = {
                ...
                "installment_count": res["payments"][0].get("installmentCount", None) if res["payments"] else None,
                "payment_option": {
                    "name": "Kredi Kartı"
                }
            }
        ...
        orderitem_set = [{
            ...
            "product": {
                ...
                "image": orderitem.get("productUrl", None) if orderitem.get("isSpecialDesign", False) is False
                            else orderitem.get("customValues", {}).get("image1", orderitem.get("productUrl", None)),
                "absolute_url": "#",
                "attributes": {
